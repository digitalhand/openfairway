...
## [br][br]
## [param altitude]: Altitude in feet (Imperial) or meters (Metric)
## [param temp]: Temperature in Fahrenheit (Imperial) or Celsius (Metric)
## [param units]: Unit system being used
## [br][br]
## Returns: Air density in kg/m³
static func get_air_density(altitude: float, temp: float, units: PhysicsEnums.Units) -> float:
	var temp_k: float
...
static func get_dynamic_viscosity(temp: float, units: PhysicsEnums.Units) -> float:
	var temp_k: float
...
## [br][br]
## Uses polynomial interpolations from wind tunnel data with
## Reynolds-dependent blending.
## [br][br]
## [param Re]: Reynolds number
## [param spin_ratio]: Spin ratio (omega * radius / velocity)
## [br][br]
